...
export default function Navbar() {
  ...
  Motif Metrics
        ...
        <div className="hidden md:flex items-center gap-6 text-sm font-medium text-charcoal">
          ...
          <a
  href="#contact"
  className="ml-4 border border-black text-black px-4 py-2 rounded-full text-sm font-medium hover:bg-black hover:text-white transition"
>
  Get Started
</a>
  ...
  <a
    href="#contact"
    onClick={toggleMenu}
    className="block w-full text-center border border-black text-black px-4 py-2 rounded-full text-sm font-medium hover:bg-black hover:text-white transition"
  >
    Get Started
  </a>
</div>
